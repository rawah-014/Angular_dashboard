...
@Component({
  selector: 'app-ic-approve-list',
  templateUrl: './ic-approve-list.component.html',
  styleUrls: ['./ic-approve-list.component.scss']
})
export class IcApproveListComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.processService.getIcApproveProcess().subscribe((data: Process[]) => {
      this.processes = data;
    });
  }
